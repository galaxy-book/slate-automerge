...
//                 currentNode.text.insertAt(offset, text);
//                 break;
//             case "remove_text":
//                 path.forEach(el => {
//                     currentNode = currentNode.nodes[el];
//                 })
//                 // Assumes no marks and only 1 leaf
//                 currentNode.text.deleteAt(offset, text.length);
//                 break;
//             case "split_node":
//                 rest.forEach(el => {
//                     currentNode = currentNode.nodes[el];
...
//                     childOne.text.splice(position)
//                     childTwo.text.splice(0, position)
//                 } else {
